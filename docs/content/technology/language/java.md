...
Java is a statically typed, compiled language that runs on the [Java Virtual Machine (JVM)](../tool/jvm.md). Its "
write once, run anywhere"
philosophy and automatic memory management made it one of the most popular languages for enterprise software
development.
