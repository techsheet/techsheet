...
- ## Open Specification
  ...
  TechSheet is an open standard, defined by a [formal specification](spec/_index.md) and [JSON Schema](spec/v2/techsheet.md).
  Files can be generated by any tool, consumed by any system, and validated automatically.
  Open, versioned, and Apache 2.0 licensed.

- ## Automated Detection

  The [Analyzer](analyzer/_index.md) scans your repository and generates a report automatically.
  It detects **47+ languages**, **84+ frameworks**, and **34+ tools**, including versions where available.
...
- ## Aggregate Across Teams
  ...
  technology usage, version drift, and team ownership.
{{% /columns %}}
