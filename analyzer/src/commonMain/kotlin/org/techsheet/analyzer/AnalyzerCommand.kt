...
import okio.SYSTEM
import org.techsheet.analyzer.reporter.ReporterFactory
import org.techsheet.analyzer.reporter.YamlReporter
...
class AnalyzerCommand : CliktCommand(name = "analyze") {
  ...
  private inline fun catchErrors(format: String, target: Path, write: () -> Unit) {
    try {
      write()
